...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton("👤 Profilim", callback_data="cmd_profile"),
         InlineKeyboardButton("📋 Buyurtmalarim", callback_data="cmd_bookings")],
        [InlineKeyboardButton("🔗 Akkaunt ulash", callback_data="cmd_connect"),
         InlineKeyboardButton("🆘 Yordam", callback_data="cmd_support")],
        [InlineKeyboardButton("❓ Buyruqlar", callback_data="cmd_help")],
    ])
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif data == "cmd_bookings":
        update.message = query.message
        await bookings_handler(update, context)
    elif data == "cmd_connect":
        update.message = query.message
        await connect_handler(update, context)
